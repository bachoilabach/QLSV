...
<body>
    ...
    <div class="header">
        <div class="add">
            <a href="./form_insert_khoa.php" class="addTitle">
                Thêm khoa
            </a>
        </div>

        <form action="./process_search_khoa.php" method="get">
        ...
        <?php foreach ($ket_qua as $each) : ?>
            <tr>
                ...
                <td class="functional">
                    ...
                    <a class="Change" href="./form_update_khoa.php?makhoa=<?php echo $each['makhoa'] ?>" style=color:black>Sửa</a>
                    </div>
                    <div style="background-color: #f12711;">
                        <a class="Del" href="./process_delete_khoa.php?makhoa=<?php echo $each['makhoa'] ?>" style=color:#fff>Xoá</a>
                    </div>
                </td>
            </tr>
        <?php endforeach ?>
