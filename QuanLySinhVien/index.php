            ...
            <tr>
                ...
                <td class="functional">
                    <div style="background-color: #6dd5ed;">
                        <a class="Change" href="form_update_SinhVien.php?masv=<?php echo $each['masv'] ?>" style=color:black>Sửa</a>
                    </div>
                    <div style="background-color: #f12711;">
                        <a class="Del" href="process_delete_SinhVien.php?masv=<?php echo $each['masv'] ?>" style=color:#fff>Xoá</a>
                    </div>
                </td>
            </tr>
        <?php endforeach ?>
